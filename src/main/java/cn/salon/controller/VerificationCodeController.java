...
import cn.salon.utils.ResourceUtil;
...
public class VerificationCodeController extends HttpServlet {
	 ...
	 * @Description: TODO
	 */
	private static final long serialVersionUID = 9192516650649105878L;
    ...
    @RequestMapping(value = "/common/generateCode", method = { RequestMethod.POST,
            RequestMethod.GET })
