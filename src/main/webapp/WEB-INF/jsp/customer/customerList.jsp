    ...
    function getLayTables() {
        ...
        layui.use('table', function (data) {
            ...
            table.render({
                ...
                , cols: [[
                    {checkbox: true}
                    , {field: 'cardNo', width: 120, title: '会员卡号', sort: true}
                    ...
                    , {
                        field: 'wallet', width: 100, title: '余额',
                        templet: '<div><span style="color: #0a0ccc;">{{d.wallet}}</span>￥</div>'
                    }
                    , {
                        field: 'payMoney', width: 100, title: '上次消费',
                        templet: '<div><span style="color: #cc080a;">{{d.payMoney}}</span>￥</div>'
                    }
                    , {title: '操作', width: 220, align: 'center', toolbar: '#barDemo'} //这里的toolbar值是模板元素的选择器
                ]]
                , response: {
                    statusCode: '200'
                }
